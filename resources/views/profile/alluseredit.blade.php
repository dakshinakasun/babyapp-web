        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                <form action="/allusers/{{ $infor->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="bdate" value="{{$infor->bdate}}">
                      </div>
                    </div>
                    @else
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>User Roll : <label style="color: red">Current: {{$infor->roll}}</label></label>
                        <select type="text" class="form-control" name="roll">
