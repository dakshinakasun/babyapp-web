...
<div class="mt-10 sm:mt-0 py-10">
    <div class="sm:container sm:mx-auto  sm:max-w-5xl sm:mt-8"> 
      <div class="mt-5 md:mt-0 md:col-span-2">
        ...
        <form action="/bb" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="shadow overflow-hidden sm:rounded-md">
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  <label for="bdate" class="block text-sm font-medium sm:mb-4 text-gray-700">Baby Birth Day</label>
                  <input type="text" name="bdate" id="bdate" value="{{ Auth::user()->bdate }}" autocomplete="bdate" class="form-input w-full" disabled>
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="clinic_date" class="block text-sm font-medium sm:mb-4 text-gray-700">Clinic date</label>
                    <input type="date" name="clinic_date" id="clinic_date" autocomplete="mweight" class="form-input w-full">
                </div>

                <div class="col-span-6 sm:col-span-3">
                    <input type="hidden" class="form-input w-full">
                </div>
