...
@section('content')
    ...
    <div class="w-4/5 m-auto pt-20">
        <form action="/wblog" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <input type="text" name="week" placeholder="Week - No.##" class="pt-10 bg-transparent block border-b-2 h-18 text-s outline-none"><br>
