...
<body class="bg-gray-100 h-screen antialiased leading-none font-sans">
    <div id="app">
        <header class="bg-gray-800 py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                <nav class="space-x-4 text-gray-300 text-sm sm:text-base">
                    ...
                    <div class="dropdown">
                      <a class="dropbtn">si <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
                      <div class="dropdown-content">
                      <a href="/wblog/{{$wpost->slug}}/en">en</a>
                      <a href="/wblog/{{$wpost->slug}}/si">si</a>
                      </div>
                    </div>
        ...
        {{-- <div class="dropdown">
            <a class="dropbtn">Language <i class="fa fa-sort-desc" aria-hidden="true"></i></a>
            <div class="dropdown-content">
            <a href="/blog/{{$post->slug}}/en">en</a>
            <a href="/blog/{{$post->slug}}/si">si</a>
            </div>
          </div> --}}
