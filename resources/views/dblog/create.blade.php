...
@section('content')
    ...
    <div class="w-4/5 m-auto pt-20">
        <form action="/dblog" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <input type="text" name="day" placeholder="Day - No.##" class="pt-10 bg-transparent block border-b-2 h-18 text-s outline-none"><br>
